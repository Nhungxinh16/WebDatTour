...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light p-1 pb-0 pt-0 ">
    <a class="navbar-brand m-0" href="index.php"><img src="content/image/logo.png" class="img-fluid ml-2" alt="Responsive image" style="max-width: 70%"></a>
      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown active p-2">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <a class="dropdown-item p-3" href="#" style="color: #282365; font-size: small;">Thuê xe</a>
        ...
        <li class="nav-item dropdown active p-2">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <a class="dropdown-item p-3" href="#" style="color: #282365; font-size: small;">Tin mới</a>
            <a class="dropdown-item p-3" href="#" style="color: #282365; font-size: small;">Tin tức du lịch</a>
            <a class="dropdown-item p-3" href="#" style="color: #282365; font-size: small;">Cẩm nang du lịch</a>
        ...
        <li class="nav-item dropdown active p-2">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <a class="dropdown-item p-3" href="#" style="color: #282365; font-size: small;">Mua tour trả chậm 0%</a>
            <a class="dropdown-item p-3" href="#" style="color: #282365; font-size: small;">Ưu đãi cùng VIB</a>
            <a class="dropdown-item p-3" href="#" style="color: #282365; font-size: small;">Ưu đãi đổi VNpay</a>
            <a class="dropdown-item p-3" href="#" style="color: #282365; font-size: small;">Hoàn tiền MSB</a>
          ...
          echo '
            <div class="dropdown show mr-5">
              ...
              <div class="dropdown-menu dropdown-menu-end" role="menu" aria-labelledby="dropdownMenuLink" >';
                ...
                echo '<a class="dropdown-item" href="profile.php">Thông tin</a>';
