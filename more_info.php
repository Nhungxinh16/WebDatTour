                            ...
                            <div class="col-md-6 col-12 left">
                                ...
                                <div class="tour">
                                    <div class="detail-tour">
                                        ...
                                        <div class="detail-tour-inner goto ">
                                            <div class="date">
                                                <span>Ngày đi -</span> <b>12/11/2021 </b>
                                            </div>
                                            <div class="from">
                                                <h4>
                                                </h4>
                                                <span><img
                                                        ...
                                                        class="flight-logo" alt="image"
                                                        onerror="this.className=&quot;d-none&quot;"></span>
                                                <h4>
                                                </h4>
                                            </div>
                                            <div class="time">
                                            ...
                                            <div class="p-line">
                                                <span><img src="/Content/Theme/images/go.png" alt="image"></span>
                                                <span><img src="/Content/Theme/images/p.png" alt="image"></span>
                                                <span><img src="/Content/Theme/images/to.png" alt="image"></span>
                                            </div>
                                            <div class="cb">
                                                <h3>Chuyến bay</h3>
                                                <p>VN TBA</p>
                                        ...
                                        <div class="detail-tour-inner comeback">
                                            <div class="date">
                                                <span>Ngày về -</span> <b>14/11/2021</b>
                                            </div>
                                            <div class="from">
                                                <h4>
                                                </h4>
                                    ...
                                    <table>
                                        <tbody>
                                            <tr>
                                                ...
                                                <th class="l3">Land tour</th>
                                            </tr>
                                            <tr>
                                                <td>Người lớn (Từ 12 tuổi trở lên)</td>
                                                <td class="t-price">24,990,000 đ</td>
                                                <td class="l-price">1,700,000 đ</td>
                                            </tr>
                                            <tr>
                                                <td>Trẻ em (Từ 5 - 11 tuổi)</td>
                                                <td class="t-price">18,790,000 đ</td>
                                                <td class="l-price">1,700,000 đ</td>
                                            </tr>
                                            <tr>
                                                <td>Trẻ nhỏ (Từ 2 - 4 tuổi)</td>
                                                <td class="t-price">8,000,000 đ</td>
                                                <td class="l-price">0 đ</td>
                                            </tr>
                                            <tr>
                                                <td>Em bé ( Dưới 2 tuổi )</td>
                                                <td class="t-price">800,000 đ</td>
                                                <td class="l-price">0 đ</td>
                                            </tr>
                                            <tr class="total">
                                                <td>Phụ thu phòng đơn</td>
                                                <td class="t-price">11,000,000 đ</td>
                                                <td class="l-price">11,000,000 đ</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
