...
<div class="mr-auto ml-auto" style="max-width: 1300px">
    ...
    <div class="card-deck">
      <div class="card uu-dai">
        <a href="#"><img src="content/image/giadinh/giadinh1.jpg" class="card-img-top" alt="..."></a>
        <div class="card-body">
          <p class="card-text mb-1"><small class="text-muted">28/10/2021 - Trong ngày - Giờ đi: 08:00</small></p>
          <a href="#"><h5 class="card-title pr-2 mb-1" style="color: #282365; font-size: medium;">Hành trình xanh Cần Giờ (Tàu cao
            tốc) - Khám phá KDL Sinh thái Dần Xây - Vàm Sát (Nhóm 6 khách)</h5></a>
          ...
          <p class="card-text"><b style="font-size: large; color:#FD5056;">17,940,000đ</b><small class="text-muted">/gia
              đình 6 khách</small></p>
          <a href="#" class="btn btn-danger" style="font-size: small; background-color: #D74449;"><i
