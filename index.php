...
<div class="mr-auto ml-auto" style="max-width: 1300px">
    ...
    <div class=".bg-light text-left " style="background-color: transparent;">
      <ul class="nav nav-pills justify-content-center mb-3" id="pills-tab" role="tablist">
        <li class="nav-item order-bar">
          <a class="nav-link p-4 text-white active text-center" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true" style="border-radius: 10px 0 0 0; font-size: small; font-weight: 600;"><span><i class="fal fa-rv"></i><br>
              Tour
              du lịch<br> trọn gói</span></a>
        </li>
        <li class="nav-item order-bar">
          <a class="nav-link p-4 text-white text-center" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false" style="border-radius: 0 0 0 0; font-size: small; font-weight:600;"><span><br> Chuyển bay <br>hồi
              hương</span></a>
        </li>
        <li class="nav-item order-bar">
          <a class="nav-link p-4 text-white text-center" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false" style="border-radius: 0 0 0 0; font-size: small; font-weight:600;"><span><br> Combo <br> Vé máy bay +
              Khách
              sạn</span></a>
        </li>
        <li class="nav-item order-bar">
          <a class="nav-link p-4 text-white text-center" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false" style="border-radius: 0 0 0 0; font-size: small; font-weight:600;"><span><br>Combo <br>Xe + Khách
              sạn</a></span>
        </li>
        <li class="nav-item order-bar">
          <a class="nav-link p-4 text-white text-center" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false" style="border-radius: 0 0 0 0; font-size: small; font-weight:600;"><span><br> Khách sạn
              <br>&emsp;</span></a>
        </li>
        <li class="nav-item order-bar">
          <a class="nav-link p-4 text-white text-center" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false" style="border-radius: 0 0 0 0; font-size: small; font-weight:600;"><span><br> Vé máy bay <br>Vietravel
              Airlines</span>
          </a>
        </li>
        <li class="nav-item order-bar">
          <a class="nav-link p-4 text-white text-center" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false" style="border-radius: 0 0 0 0; font-size: small; font-weight:600;"><span><br> Tra cứu booking
              <br>&emsp;</span></a>
        </li>
        <li class="nav-item order-bar">
          <p class="nav-link p-4 text-white" id="pills-contact-tab" data-toggle="none" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false" style="border-radius: 0 10px 0 0;">
            &emsp;&emsp;</p>
        </li>
      </ul>
    </div>
    <div class="tab-content" id="pills-tabContent">
      <div class=".bg-white tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
        <br>
      </div>
      ...
      echo '
            <div class="row" id="box-search">
              <div class="thumbnail text-center">
                <div class="m-4 mr-5"><a href="listtour.php?tour_type=' . $type["tour_type_id"] . '"><img src="' . $type["image"] . '"
      ...
      echo '
            <div class="card uu-dai">
              ...
              <div class="card-body">
                ...
                <a href="booking.php?tour_id=' . $t["tour_id"] . '" ';
                if(!isset($_SESSION["user_id"])){
                  echo 'onclick="return check_login()"';
                }
                echo 'class="btn btn-danger" style="font-size: small; background-color: #D74449;"><i
  ...
  <br>
  <button type="button" class="btn btn-light pl-4 pr-4" style="float: right; background-color: white; border: 1px solid rgb(202, 200, 194); color: #282365; font-weight: 600;">Xem
